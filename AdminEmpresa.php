...
<br>
    ...
    <table class="table table-striped table-hover table-condensed">
        <thead>
            ...
            <th style="text-align: center; background-color: #FAFAFA; color: black;"><?php echo $dto->__($lng, "Hora electiva"); ?></th>
...
?>
                                            <input type='checkbox' id="chk1marcatge" <?php echo $chk1marcatge; ?> style="width: 25px; height: 25px;" onchange='marcaPrimerMarcaje(<?php echo $idempresa; ?>,1);'>
                                        </div>
                                    </div>
