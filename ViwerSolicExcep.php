  ...
  .btn-blue:hover {
    ...
    <div class="modal fade" id="modContent"></div>
       <?php
        ...
        $result = $dto->getDb()->executarConsulta('SELECT excepcio.idresp,excepcio.idtipusexcep,excepcio.idexcepcio, empleado.nom as empleatnom, tipusexcep.nom as tipusexcepnom , datainici , datafinal'
            .' , excepcio.observacions , empleRespns.nom as empleRespnsnom , aprobada , dataaprovacio , excepcio.idempleat '
        ...
        $i = 0;
            foreach ($result as $row)
            {
                    ...
                    if($TypeView == '957'){
                        $tblpers.="<td>".$row["empleRespnsnom"]."</td>";
                    }
