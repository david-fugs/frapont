...
$horesteoany = $dto->seleccionaHoresTeoriques($id);
...
$rs = $dto->seleccionaEmpPerId($id);
foreach ($rs as $fitxa) {
    echo '<tr><th>' . $dto->__($lng, "Fecha Inicio Contrato") . '</th><td><input type="date" onblur="actualitzaCampTaulaNR(' . "'empleat','ordredist'," . $id . ',this.getAttribute(' . "'data-old_value'" . '),this.value);"'
