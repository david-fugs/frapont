...
foreach ($result as $row) {
    ...
    . '<td><form method="get"></form><form name="frmf' . $idempleat . '" method="get" action="AdminFitxaEmpleat.php"><input type="hidden" name="id" value="' . $idempleat . '"><button class="btn-neutro btn-small" onclick="this.form.submit();" title="' . $dto->__($lng, "Veure Fitxa") . '"><span class="glyphicon glyphicon-user"></span></button></form></td>'
    . '<td><form name="frmc' . $idempleat . '" method="get" action="AdminHorarisEmpleat.php"><input type="hidden" name="id" value="' . $idempleat . '"><button class="btn-blue btn-small" onclick="this.form.submit();" title="' . $dto->__($lng, "Veure Calendari") . '"><span class="glyphicon glyphicon-calendar"></span></button></form></td>'
    . '<td><form name="frmm' . $idempleat . '" method="get" action="AdminMarcatgesEmpleat.php"><input type="hidden" name="id" value="' . $idempleat . '"><button class="btn-next btn-small" onclick="this.form.submit();" title="' . $dto->__($lng, "Veure Marcatges") . '"><span class="glyphicon glyphicon-zoom-in"></span></button></form></td>'
    . "<td>" . $rolpers . "</td>"
