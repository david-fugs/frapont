...
$idtreballadorsemp = $dto->getTreballadorsIdEmpresaMarcatge($any, $mes);
$zmes = $mes;
...
GROUP BY t1.id_emp, DATE(t1.datahora)";
            ...
            function calcularTotalHoras($entrada1, $salida1, $entrada2, $salida2) {
                            ...
                            while ($fechaInicio <= $fechaFin) {
                                ...
                                foreach ($idtreballador['rows'] as $row) {
                                    ...
                                    if ($diaActual == $fechaRegistro) {
                                        ...
                                        $data_time= calcularTotalHoras($row['entrada1'], $row['salida1'], $row['entrada2'], $row['salida2']);
                                        ...
                                        // Verifica el valor de $totalHoras y ajusta $horesteoriques en consecuencia
                                        if ($totalHoras < 0) {
                                            $horesteoriques = "08:00"; // Si $totalHoras es negativo, establece 08:00.
                                        } elseif ($totalHoras >= 1 && $totalHoras <= 3) {
                                            $horesteoriques = "08:00"; // Si $totalHoras está entre 1 y 3, establece 08:00.
                                        } elseif ($totalHoras > 3 && $totalHoras <= 6.5) {
                                            $horesteoriques = "06:00"; // Si $totalHoras está entre 4 y 6.5, establece 06:00.
                                        } elseif ($totalHoras > 7) {
                                            $horesteoriques = "08:00"; // Si $totalHoras es mayor a 7, establece 08:00.
                                        }
